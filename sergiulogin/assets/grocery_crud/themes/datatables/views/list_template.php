...
<?php }?>
<div id='list-report-error' style='color:blue;' class='report-div error report-list'></div>
<div id='list-report-success' style='color:blue;' class='report-div success report-list' <?php if($success_message !== null){?>style="display:block"<?php }?>><?php
