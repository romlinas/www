...
function inkthemes_optionsframework_options_page() {
    ...
    <?php echo $return[1] ?>
            ...
            <div class="save_bar_top">
                ...
                <input type="submit" value="Сохранить все изменения" class="button-primary" />
        </form>
        <form action="<?php echo esc_attr($_SERVER['REQUEST_URI']) ?>" method="post" style="display:inline" id="ofform-reset">
            ...
            <span class="submit-footer-reset">
                <input name="reset" type="submit" value="Сброс настроек" class="button submit-button reset-button" onclick="return confirm('Click OK to reset. Any settings will be lost!');" />
