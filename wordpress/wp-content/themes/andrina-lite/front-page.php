...
<div class="full-content">
    <div class="feature-content">
        ...
        <?php } else { ?>        
            <h1><?php _e('Наши работы', 'andrina-lite'); ?></h1>
        <?php } ?>        
        <div class="feature-item">
            ...
            <?php } else { ?>            
                <h4><?php _e('Заголовок работы.', 'andrina-lite'); ?></h4>
            <?php } ?>            
            <?php if (inkthemes_get_option('inkthemes_f_des1') != '') { ?>
                <p><?php echo stripslashes(inkthemes_get_option('inkthemes_f_des1')); ?></p>
            <?php } else { ?>
                <p><?php _e('Текст описания работы-проекта, заменяется в админке, в настройках темы.', 'andrina-lite'); ?></p>
            <?php } ?>            
        </div>
        <div class="feature-item">
    ...
    <div class="bottom-feature">
        <div class="bottom-feature-left">
            ...
            <?php } else { ?>
                <h1><?php _e('Записи', 'andrina-lite'); ?></h1>
            <?php } ?> 
...
<?php wp_reset_query(); ?>
        ...
        <div class="bottom-feature-right">
            ...
            <?php } else { ?>
                <h1><?php _e('Новые работы', 'andrina-lite'); ?></h1>
                <?php } ?>            
...
<?php } else { ?>
                    <iframe width="282" height="210" src="http://www.youtube.com/embed/miAMATblEE8" frameborder="0" allowfullscreen></iframe>
                    <p><?php _e("Описание работы, можно поменять из админке в настройках темы.",'andrina-lite'); ?></p>
<?php } ?>                
            </div>
        </div>
    </div>
...
<div class="index-info">
    <div class="grid_6 alpha">
        <div class="index-info-one">            
            ...
            <?php } else { ?>
                <span><?php _e('91 9926 465653', 'andrina-lite'); ?></span>
<?php } ?>                       
        </div>
    </div>
    <div class="grid_7">
        <div class="index-info-two">
            ...
            <?php } else { ?>
                <span><?php _e('admin@inkthemes.com', 'andrina-lite'); ?></span>
<?php } ?>               
        </div>
    </div>
    <div class="grid_11 omega">
        <div class="index-info-three">
            ...
            <?php } else { ?>
                <span><?php _e('С понедельника по субботу, с 10:00 до 18:00', 'andrina-lite'); ?></span> 
<?php } ?>            
        </div>
    </div>
</div>
