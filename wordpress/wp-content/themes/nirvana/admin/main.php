...
/*** socials ***/
	add_settings_field('nirvana_socials1', __('Link nr. 1','nirvana') , 'cryout_setting_socials1_fn', 'nirvana-page', 'socials_section');
	add_settings_field('nirvana_socials2', __('Link nr. 2','nirvana') , 'cryout_setting_socials2_fn', 'nirvana-page', 'socials_section');
	add_settings_field('nirvana_socials3', __('Link nr. 3','nirvana') , 'cryout_setting_socials3_fn', 'nirvana-page', 'socials_section');
	add_settings_field('nirvana_socials4', __('Link nr. 4','nirvana') , 'cryout_setting_socials4_fn', 'nirvana-page', 'socials_section');
	add_settings_field('nirvana_socials5', __('Link nr. 5','nirvana') , 'cryout_setting_socials5_fn', 'nirvana-page', 'socials_section');
