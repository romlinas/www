...
$themename = "dreams_construction_wp";
$shortname = "artisteer";
...
$options = array (
                array(  "name" => "Header Ad 468x60",
                        "desc" => "This is for the 468x60 Google AdSense banner in the header.<br /><br />",
                        "id" => "dre_banner",
                        "std" => "(Input html or adsense code here)",
                        "type" => "textarea"),
		array(  "name" => "Sidebar Ad 200x200",
                        "desc" => "This is for the 200x200 Google AdSense banner in the sidebar.<br /><br />",
                        "id" => "dre_adsense_250",
                        "std" => "(Input html or adsense code here)",
                        "type" => "textarea"),
                array(  "name" => "Footer",
...
function art_add_admin() {
    ...
    add_theme_page("Dreams Construction WP Options", "Dreams Construction WP Options", 'edit_themes', basename(__FILE__), 'art_admin');
...
?>
<div class="wrap">
	<h2>Dreams Construction WP Options</h2>
