        ...
        <div id="main" class="col620 clearfix" role="main">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title author"><?php printf( __( 'Author: %s', 'newswire' ), '<span class="vcard"><a class="url fn n colortxt" href="' . get_author_posts_url( get_the_author_meta( "ID" ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></h1>
				</header>
