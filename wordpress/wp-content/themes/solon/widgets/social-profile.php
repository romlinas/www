<?php
 class Solon_Social_Profile extends WP_Widget {
	...
	function form( $instance ) {
		...
		if ( !$menus ) {
			echo '<p>'. sprintf( __('No menus have been created yet. <a href="%s">Create some</a>.', 'solon'), admin_url('nav-menus.php') ) .'</p>';
			return;
		}
		?>
		<p>
