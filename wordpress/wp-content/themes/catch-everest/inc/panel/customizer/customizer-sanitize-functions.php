 ...
 * @since Catch Everest 1.4
 */
function catcheverest_reset_all_settings( $input ) {
	if ( $input == 1 ) {
 ...
 * @since Catch Everest 1.4
 */
function catcheverest_sanitize_important_link() {
	return false;
}
 ...
 * @since Catch Everest 1.4
 */
function catcheverest_sanitize_reset_featured_image( $input ) {
 ...
 * @since Catch Everest 1.4
 */
function catcheverest_sanitize_reset_layout( $input ) {
	//Reset Header Featured Image Options
	if( $input == 1 ) {
		global $catcheverest_options_settings, $catcheverest_options_defaults;
 ...
 * @since Catch Everest 1.4
 */
function catcheverest_sanitize_reset_moretag( $input ) {
	//Reset Header Featured Image Options
	if( $input == 1 ) {
		global $catcheverest_options_settings, $catcheverest_options_defaults;
