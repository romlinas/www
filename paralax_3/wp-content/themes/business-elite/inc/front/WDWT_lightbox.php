...
class WDWT_Lightbox {
  ...
  public function __construct() {
    ...
    $this->wdwt_front = new Business_elite_front($wdwt_options);  
...
public function view() {
    ...
    <script>
      ...
      foreach ($image_rows as $key => $image_row) {        
        ...
        wdwt_data["<?php echo $key; ?>"]["description"] = "<?php echo esc_attr(isset($descr_rows[$key]) ? $descr_rows[$key] : '' ); ?>" ;
    ...
    <?php
    if (!$image_id_exist) {
      echo '<div style="width:99%"><div class="error"><p><strong>' . __('The image has been deleted.', "business-elite") . '</strong></p></div></div>';
      die();
    }
    ?>
    ...
    <div class="wdwt_image_wrap">
      ...
      <div class="wdwt_btn_container">
        <div class="wdwt_ctrl_btn_container">
          ...
          if ($enable_image_ctrl_btn) {
            ?>
          <i title="<?php esc_attr_e('Play', "business-elite"); ?>" class="wdwt_ctrl_btn wdwt_play_pause fa fa-play"></i>
          <?php
          }
          if ($enable_image_fullscreen) {
            if (!$open_with_fullscreen) {
          ?>
          <i title="<?php esc_attr_e('Maximize', "business-elite"); ?>" class="wdwt_ctrl_btn wdwt_resize-full fa fa-resize-full "></i>
          <?php
          }
          ?>
          <i title="<?php echo esc_attr_e('Fullscreen', "business-elite"); ?>" class="wdwt_ctrl_btn wdwt_fullscreen fa fa-fullscreen"></i>
          <?php } 
          if ($popup_enable_info) { ?>
          <i title="<?php echo esc_attr_e('Show info', "business-elite"); ?>" class="wdwt_ctrl_btn wdwt_info fa fa-info"></i>
          <?php
          }
          if ($popup_enable_fullsize_image) {
            ?>
            <a id="wdwt_fullsize_image" href="<?php echo $current_image_url; ?>" target="_blank">
              <i title="<?php echo esc_attr_e('Open image in original size.', "business-elite"); ?>" class="wdwt_ctrl_btn fa fa-external-link"></i>
            </a>
            <?php
          }
          ?>
      ...
      <div id="wdwt_image_container" class="wdwt_image_container">
        <div class="wdwt_image_info_container1">
          <div class="wdwt_image_info_container2">
            <span class="wdwt_image_info_spun">
              <div class="wdwt_image_info" <?php if(trim($current_image_alt) == '' && trim($current_image_description) == '') { echo 'style="background-color:none;"'; } ?>>
                <?php if($current_image_alt!=''){ ?>
					<div class="wdwt_image_title"><?php echo html_entity_decode($current_image_alt); ?></div>
				<?php }
				else { ?>
					<style>  .wdwt_image_info {padding:0 !important;} </style>
				<?php } ?>
        ...
        <a id="spider_popup_left"><span id="spider_popup_left-ico"><span><i class="wdwt_prev_btn fa fa-chevron-left"></i></span></span></a>
        <a id="spider_popup_right"><span id="spider_popup_right-ico"><span><i class="wdwt_next_btn fa fa-chevron-right"></i></span></span></a>
      </div>
    </div>
    <a class="spider_popup_close" onclick="wdwt_lbox.destroypopup(1000); return false;" ontouchend="wdwt_lbox.destroypopup(1000); return false;"><span><i class="wdwt_close_btn fa fa-times"></i></span></a>
    ...
    <script>
      ...
      if ((jQuery("#spider_popup_wrap").width() >= jQuery(window).width()) || (jQuery("#spider_popup_wrap").height() >= jQuery(window).height())) {
        jQuery(".spider_popup_close").attr("class", "wdwt_ctrl_btn spider_popup_close_fullscreen");
      }
      /* Stop autoplay.*/
      ...
      function wdwt_cube(tz, ntx, nty, nrx, nry, wrx, wry, current_image_class, next_image_class, direction) {
        ...
        function wdwt_after_trans() {
          ...
          if (typeof wdwt_event_stack !== 'undefined' && wdwt_event_stack.length > 0) {
            key = wdwt_event_stack[0].split("-");
            wdwt_event_stack.shift();
      ...
      function wdwt_change_image(current_key, key, wdwt_data, from_effect) {
        if (typeof wdwt_data[key] != 'undefined' && typeof wdwt_data[current_key] != 'undefined') {
          ...
          if (wdwt_trans_in_progress) {
            wdwt_event_stack.push(current_key + '-' + key);
            return;
          }
          var direction = 'right';
      ...
      function wdwt_popup_resize() {
        ...
        if (typeof jQuery().fullscreen !== 'undefined' && jQuery.isFunction(jQuery().fullscreen) && !jQuery.fullscreen.isFullScreen()) {
          ...
          jQuery(".wdwt_resize-full").attr("title", "<?php esc_attr_e('Maximize', "business-elite"); ?>");
          jQuery(".wdwt_fullscreen").attr("class", "wdwt_ctrl_btn wdwt_fullscreen fa fa-fullscreen");
          jQuery(".wdwt_fullscreen").attr("title", "<?php esc_attr_e('Fullscreen', "business-elite"); ?>");
        }
      ...
      jQuery(document).ready(function () {
        ...
        jQuery("#spider_popup_left").on(wdwt_click, function () {
        ...
        jQuery("#spider_popup_right").on(wdwt_click, function () {
        ...
        jQuery(".wdwt_info").on(wdwt_click, function() {
          ...
          if (jQuery(".wdwt_image_info_container1").css("display") == 'none') {
            jQuery(".wdwt_image_info_container1").css("display", "table-cell");
            jQuery(".wdwt_info").attr("title", "<?php echo __('Hide info', "business-elite"); ?>");
          }
          else {
            jQuery(".wdwt_image_info_container1").css("display", "none");
            jQuery(".wdwt_info").attr("title", "<?php echo __('Show info', "business-elite"); ?>");
          }
        ...
        jQuery(".wdwt_resize-full").on(wdwt_click, function () {
          ...
          if (jQuery(".wdwt_resize-full").hasClass("fa-resize-small")) {
            ...
            jQuery(".wdwt_resize-full").attr("class", "wdwt_ctrl_btn wdwt_resize-full fa fa-resize-full");
            jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Maximize', "business-elite"); ?>");
          }
          else {
            wdwt_popup_current_width = jQuery(window).width();
            wdwt_popup_current_height = jQuery(window).height();
            ...
            jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Restore', "business-elite"); ?>");
            jQuery(".spider_popup_close").attr("class", "wdwt_ctrl_btn spider_popup_close_fullscreen");
          }
        ...
        jQuery(".wdwt_fullscreen").on(wdwt_click, function () {
          ...
          function wdwt_exit_fullscreen() {
            ...
            jQuery("#spider_popup_wrap").on("fscreenclose", function() {
              ...
              jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Maximize', "business-elite"); ?>");
              jQuery(".wdwt_fullscreen").attr("class", "wdwt_ctrl_btn wdwt_fullscreen fa fa-fullscreen");
              jQuery(".wdwt_fullscreen").attr("title", "<?php echo __('Fullscreen', "business-elite"); ?>");
              if ((jQuery("#spider_popup_wrap").width() < jQuery(window).width()) && (jQuery("#spider_popup_wrap").height() < jQuery(window).height())) {
                jQuery(".spider_popup_close_fullscreen").attr("class", "spider_popup_close");
              }
            });
          ...
          if (typeof jQuery().fullscreen !== 'undefined' && jQuery.isFunction(jQuery().fullscreen)) {
            if (jQuery.fullscreen.isFullScreen()) {
              ...
              jQuery("#spider_popup_wrap").fullscreen();
                ...
                jQuery(".wdwt_fullscreen").attr("title", "<?php esc_attr_e('Exit Fullscreen', "business-elite"); ?>");
                jQuery(".spider_popup_close").attr("class", "wdwt_ctrl_btn spider_popup_close_fullscreen");
        ...
        jQuery(".wdwt_play_pause, .wdwt_popup_image").on(wdwt_click, function () {
          if (jQuery(".wdwt_ctrl_btn").hasClass("fa-play")) {
            /* PLay.*/
            wdwt_play();
            jQuery(".wdwt_play_pause").attr("title", "<?php echo __('Pause', "business-elite"); ?>");
            ...
            window.clearInterval(wdwt_playInterval);
            jQuery(".wdwt_play_pause").attr("title", "<?php echo __('Play', "business-elite"); ?>");
