...
function wdwt_customizer_add_panels($wp_customize ){
  ...
  */
  ...
  $general_links_priority = $wp_customize->get_section( 'general_main' )->priority;
...
function wdwt_customizer_add_scripts(){
  ...
  wp_localize_script( 'wdwt_customizer-preview', 'wdwt_slide_warning', __("You cannot delete the last slide! Try to turn off the slider", "business-elite") );
