...
$pluginURI = '/themes/wp-content/themes/imbalance_black/js/';


// load scripts
if (!is_admin()) add_action( 'init', 'photo_galleria_load_scripts' );
function photo_galleria_load_scripts( ) {
	wp_enqueue_script('photo-galleria','/wp-content/themes/imbalance_black/js/photo-galleria/js/jquery.galleria.js', array('jquery'));
	wp_enqueue_style('photo-galleria-css', '/wp-content/themes/imbalance_black/js/photo-galleria/css/galleria.css', array(), '1.0' );
}
