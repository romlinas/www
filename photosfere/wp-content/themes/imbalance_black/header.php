...
<body <?php body_class(); ?>>
	...
	<div id="outer">
        ...
        <div id="menu">
            <div id="navicons">
                <ul>
                    <li><a id="subscribe" href="<?php bloginfo('rss2_url'); ?>" title="">Подписка</a></li>
            ...
            <div id="cats">
            	<ul>
                	<li><a href="<?php bloginfo("url"); ?>/" title=""<?php if ( is_front_page()) { ?> class="active"<?php } ?>>Главная</a></li>
                	<li><a href="#" rel="toggle[categories]" title="">Рубрики</a></li>
                	<li><a href="#" rel="toggle[archives]" title="">Архивы</a></li>
                	<?php
				    if ( function_exists( 'wp_nav_menu' ) ) {
					    ...
					    { custom_menu(); }
					?>
                	<li><a href="#" rel="toggle[search]" title="">Поиск</a></li>
                </ul>
            </div>
        </div>
        <div id="categories">
