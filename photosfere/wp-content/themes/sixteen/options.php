...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Код в Header', 'options_framework_theme'),
		'desc' => __('Вставьте скрипты или код перед закрытием &lt;/head&gt; ', 'options_framework_theme'),
		'id' => 'headcode1',
		'std' => '',
		'type' => 'textarea');
		
	$options[] = array(
		'name' => __('Код в Footer', 'options_framework_theme'),
		'desc' => __('Вставьте скрипты или код перед закрытием &lt;/body&gt; ', 'options_framework_theme'),
		'id' => 'footercode1',
		'std' => '',
		'type' => 'textarea');	
	...
	$options[] = array(
		...
		'desc' => __('Текст автора в подвале', 'options_framework_theme'),
		'id' => 'footertext2',
		'std' => '',
		'type' => 'textarea');
	...
	$options[] = array(
		'name' => __('Настройки расположения', 'options_framework_theme'),
		'type' => 'heading');	
	
	$options[] = array(
		'name' => "Расположение Sidebar",
		'desc' => "Расположение на записях и страницах",
		'id' => "sidebar-layout",
		'std' => "right",
		'type' => "images",
		'options' => array(
	...
	$options[] = array(
		'name' => __('Включение Slider', 'options_framework_theme'),
		'desc' => __('Поставьте галочку чтобы включить слайдер.', 'options_framework_theme'),
		'id' => 'slider_enabled',
		'type' => 'checkbox',
		'std' => '0' );
		
	$options[] = array(
		'desc' => __('Можно добавить 5 слайдов, рекомендуемая ширина: 1180px.', 'options_framework_theme'),
		'type' => 'info');
	...
	$options[] = array(
		'desc' => __('Заголовок', 'options_framework_theme'),
		'id' => 'slidetitle1',
		'std' => '',
		'type' => 'text');
	
	$options[] = array(
		'desc' => __('Текст описания', 'options_framework_theme'),
		'id' => 'slidedesc1',
		'std' => '',
		'type' => 'textarea');			
	...
	$options[] = array(
		'desc' => __('Настройки социальных сетей', 'options_framework_theme'),
		'type' => 'info');
