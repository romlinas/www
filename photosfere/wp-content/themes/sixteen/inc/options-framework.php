...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Sixteen Theme Options', 'optionsframework'),
		'menu_title' => __('Sixteen Settings', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'Sixteen-options',
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Сохранить параметры', 'options_framework_theme' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'По умолчанию', 'options_framework_theme' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Нажмите OK, чтобы сбросить настройки темы.', 'options_framework_theme' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Настройки по умолчанию восстановлены.', 'options_framework_theme' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( 'Настройки сохранены.', 'options_framework_theme' ), 'updated fade' );
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Sixteen Settings', 'options_framework_theme' ),
			'href' => admin_url( 'themes.php?page=Sixteen-options' )
		));
}
