...
$options = array (
	...
	array("name" => "Фоновое изображение по умолчанию",
			"desc" => "Фоновое изображение для страниц без слайд-шоу ",
            "id" => $shortname."_default",
			"std" => get_bloginfo('template_directory')."/img/default.jpg",
            "type" => "text"), 		
			
	array(  "type" => "close"),	

	
	array( "name" => "Параметры слайд-шоу ",
            "type" => "title",
			"desc" => " ",
       		),
	...
	array(  "name" => "Выберите эффект смены слайда",
			"desc" => "0-None, 1-Fade, 2-Slide Top, 3-Slide Right, 4-Slide Bottom, 5-Slide Left, 6-Carousel Right, 7-Carousel Left ",
			"id" => $shortname."_effect",
            "type" => "select",		
			"options" => array('0','1','2','3','4','5','6','7'),		
   		    "std" => "1"),		
			
	array("name" => "Скорость перехода",
			"desc" => "Введите скорость перехода в миллисекундах ( 1000 = 1 sec).",
            "id" => $shortname."_speed",
        	"std" => "1000",
            "type" => "text"), 		
