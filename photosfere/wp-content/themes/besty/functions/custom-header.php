 ...
 *
 */
function besty_custom_header_setup() {
	/**
	 *     @param array $args {
	...
	add_theme_support( 'custom-header', apply_filters( 'besty_custom_header_args', array(
		...
		'admin-preview-callback' => 'besty_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'besty_custom_header_setup' );
if ( ! function_exists( 'besty_header_style' ) ) :
/**
 ...
 *
 */
function besty_header_style() {
	$besty_text_color = get_header_textcolor();
...
endif; // besty_header_style
if ( ! function_exists( 'besty_admin_header_style' ) ) :
/**
...
endif; // besty_admin_header_style
if ( ! function_exists( 'besty_admin_header_image' ) ) :
/**
