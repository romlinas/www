...
<?php if(get_option('wall_homelayout') == "blog") { ?>
...
<div class="postmeta">
	<span class="author">Опубликовал <?php the_author(); ?> </span> <span class="clock">  <?php the_time('M - j - Y'); ?></span> <span class="comm"><?php comments_popup_link('0 комментарий', '1 комментариев', '% комментариев'); ?></span>
</div>
