...
function fallbackmenu(){ ?>
		...
		<ul class="sf-menu sf-vertical">
			<li class="page_item <?php if ( is_home() ) { ?>current_page_item<?php } ?>"><a href="<?php echo get_settings('home'); ?>/" title="Home">Главная</a></li>
...
<?php wp_pagenavi() ?>
<?php else : ?>
        <div class="alignleft"><?php next_posts_link(__('&laquo; Предыдущие записи','arclite')) ?></div>
        <div class="alignright"><?php previous_posts_link(__('Следующие записи &raquo;','arclite')) ?></div>
        <div class="clear"></div>
<?php endif; ?>
