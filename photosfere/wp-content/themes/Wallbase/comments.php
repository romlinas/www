...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number('Комментариев нет', '1 комментарий', '% комментариев' );?>.</h3>
...
<p>Вы должны быть <a href="<?php echo wp_login_url( get_permalink() ); ?>">авторизованы</a>, чтобы разместить комментарий.</p>
<?php else : ?>
