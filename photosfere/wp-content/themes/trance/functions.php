...
function trance_scripts() {
	...
	wp_enqueue_style('bootstrap-style',get_template_directory_uri()."/assets/bootstrap/bootstrap.css", array('style'));
	
	wp_enqueue_style('trance-main-skin',get_template_directory_uri()."/assets/css/main.css", array('bootstrap-style'));
	
	wp_enqueue_style('font-awesome', get_template_directory_uri()."/assets/font-awesome/font-awesome.min.css", array('trance-main-skin'));
...
?>
	...
	<div class="comment-meta commentmetadata"><a href="<?php echo esc_html( get_comment_link( $comment->comment_ID ) ); ?>">
		<?php
			...
			printf( __('%1$s','trance'), get_comment_date() ); ?></a><?php edit_comment_link( __( '(Edit)','trance' ), '  ', '' );
		?>
	</div>
