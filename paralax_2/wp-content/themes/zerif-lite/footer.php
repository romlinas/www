...
<div class="container">
	...
	<?php
		...
		!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
					...
					echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="http://themeisle.com/themes/zerif-lite/"'.$attribut_new_tab.' rel="nofollow">NectaR </a>'.__('powered by','zerif-lite').'<a class="zerif-copyright" href="http://wordpress.org/"'.$attribut_new_tab.' rel="nofollow"> IT-Professional</a></div>';
