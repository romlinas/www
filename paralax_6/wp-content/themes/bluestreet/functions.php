<?php
add_action( 'wp_enqueue_scripts', 'bluestreet_theme_css',999);
function bluestreet_theme_css() {
    wp_enqueue_style( 'bluestreet-parent-style', get_template_directory_uri() . '/style.css' );
    wp_enqueue_style( 'bluestreet-child-style', get_stylesheet_uri(), array( 'bluestreet-parent-style' ) );
}
