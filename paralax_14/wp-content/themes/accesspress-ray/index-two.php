	...
	<div class="ak-container">
		...
		if(!empty($featured_post1) || !empty($featured_post2) || !empty($featured_post3) || !empty($featured_post4)){
					...
					?>
						<div class="featured-post-wrapper">
							...
							<div class="featured-more">
								<div><span>+</span></div><a href="<?php the_permalink(); ?>"><?php echo esc_attr($accesspress_ray_settings['featured_post_readmore']); ?></a></div>
						</div>
				...
				<div id="featured-post-2" class="featured-post">
					...
					?>
						<div class="featured-post-wrapper">
							...
							<div class="featured-more">
								<div><span>+</span></div>
								<a href="<?php the_permalink(); ?>"><?php echo esc_attr($accesspress_ray_settings['featured_post_readmore']); ?></a></div>
						</div>
				...
				<div id="featured-post-3" class="featured-post">
					...
					?>
						<div class="featured-post-wrapper">
							...
							<div class="featured-more"><div><span>+</span></div><a href="<?php the_permalink(); ?>"><?php echo esc_attr($accesspress_ray_settings['featured_post_readmore']); ?></a></div>
						</div>
			...
			<div id="featured-post-<?php echo $featured_post; ?>" class="featured-post">
				...
				<div class="featured-post-wrapper">
                    <figure class="featured-image"><img src="<?php echo get_template_directory_uri().'/images/demo/featuredimage-'.$featured_post.'.jpg' ?>"></figure>
                    <div class="featured-more"><div><span>+</span></div><a href="#"><?php _e('Read More','accesspress-ray'); ?></a></div>
                </div>
...
<section id="top-section" class="events-section clearfix">
	<div id="latest-events" class="ak-container clearfix">
	        ...
	        <a href="<?php echo get_category_link($accesspress_ray_blog_cat); ?>" class="view-all clearfix"><?php _e('view all','accesspress-ray');?></a>
			<?php }else{ ?>
	        ...
	        <div class="event-slider">
		        ...
		        <a href="#" class="view-all clearfix"><?php _e('view all','accesspress-ray') ?></a>
		    </div>
	        <?php }  ?>	
	</div>
</section>
