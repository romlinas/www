			...
			<h3><?php _e('Basic Settings','accesspress-ray'); ?></h3>
				<table class="form-table">
					...
					<tr>
                        ...
                        <td>
                        	<?php if( !isset( $settings['secondary_theme_color'] ) ) { $settings['secondary_theme_color'] = '#f063d'; } ?>
					...
					<tr>
						...
						<td>
							<div class="accesspress_ray_fav_icon">
							  ...
							  <div class="accesspress_ray_remove_upload" id="accesspress_ray_fav_icon_remove"><?php _e('Remove','accesspress-ray'); ?></div>
							  </div>
							  <?php }else{ ?>
					...
					<tr>
						...
						<td>
							<div class="upload_featured_section_bg">
							  <input class="medium" type="text" name="accesspress_ray_options[featured_section_bg]" id="accesspress_ray_featured_section_bg" value="<?php if(!empty($settings['featured_section_bg'])){ echo esc_url($settings['featured_section_bg']); }?>" />
							  ...
							  <div class="accesspress_ray_remove_upload" id="accesspress_ray_featured_section_bg_remove"><?php _e('Remove','accesspress-ray'); ?></div>
							  </div>
							  <?php }else{ ?>
					...
					<tr>
						...
						<td>
							<div class="upload_testimonial_section_bg">
							  <input class="medium" type="text" name="accesspress_ray_options[testimonial_section_bg]" id="accesspress_ray_testimonial_section_bg" value="<?php if(!empty($settings['testimonial_section_bg'])){ echo esc_url($settings['testimonial_section_bg']); }?>" />
							  ...
							  <div class="accesspress_ray_remove_upload" id="accesspress_ray_testimonial_section_bg_remove"><?php _e('Remove','accesspress-ray'); ?></div>
							  </div>
							  <?php }else{ ?>
			...
			<h3><?php _e('Know more about AccessPress Themes','accesspress-ray'); ?></h3>
				<table class="form-table">
					...
					<td colspan="2">
						...
						$other_product .= __('Our Themes - ','accesspress-ray'). __(sprintf('<a href="%s" target="_blank">https://accesspressthemes.com/themes</a>','https://accesspressthemes.com/wordpress-themes/'))."<br><br>" ;
						$other_product .= __('Our Plugins - ','accesspress-ray'). __(sprintf('<a href="%s" target="_blank">https://accesspressthemes.com/plugins</a>','https://accesspressthemes.com/plugins'))."<br><br>" ;
						echo $other_product;
						?>
						<hr />
