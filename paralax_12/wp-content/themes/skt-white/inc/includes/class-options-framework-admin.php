...
class Options_Framework_Admin {
     ...
     */
	 function options_page() { ?>
        ...
        <div style="padding-top:10px;font-size:15px;"><a href="<?php echo esc_url(SKT_PRO_THEME_URL); ?>" target="_blank"><?php _e('Buy PRO version for only $39 with more features.','skt-white'); ?></a></div>
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
            ...
            <div class="meta-box-sortables ui-sortable">
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <p><em><a href="<?php echo esc_url(SKT_PRO_THEME_URL);?>" target="_blank"><?php _e('Buy PRO version for only $39 with more features','skt-white'); ?></a></em></p>
                    </div>
                </div>
                <div class="postbox">
