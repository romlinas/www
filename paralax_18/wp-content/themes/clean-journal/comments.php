...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'clean-journal' ),
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation">
			<h1 class="screen-reader-text"><?php _e( 'Comment navigation', 'clean-journal' ); ?></h1>
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'clean-journal' ); ?></p>
	<?php endif; ?>
