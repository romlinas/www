...
if ( ! defined( 'CLEAN_JOURNAL_THEME_VERSION' ) ) {
	...
	$clean_journal_enable_featured_header_image_options = clean_journal_enable_featured_header_image_options();
	$choices = array();
	foreach ( $clean_journal_enable_featured_header_image_options as $clean_journal_enable_featured_header_image_option ) {
		$choices[$clean_journal_enable_featured_header_image_option['value']] = $clean_journal_enable_featured_header_image_option['label'];
	}

	$wp_customize->add_control( 'clean_journal_theme_options[enable_featured_header_image]', array(
			'choices'  	=> $choices,
			'label'		=> __( 'Enable Featured Header Image on ', 'clean-journal' ),
	...
	$clean_journal_featured_image_size_options = clean_journal_featured_image_size_options();
	$choices = array();
	foreach ( $clean_journal_featured_image_size_options as $clean_journal_featured_image_size_option ) {
		$choices[$clean_journal_featured_image_size_option['value']] = $clean_journal_featured_image_size_option['label'];
	}

	$wp_customize->add_control( 'clean_journal_theme_options[featured_image_size]', array(
			'choices'  	=> $choices,
			'label'		=> __( 'Page/Post Featured Header Image Size', 'clean-journal' ),
			'section'   => 'header_image',
	...
	$wp_customize->add_control( 'clean_journal_theme_options[featured_header_image_alt]', array(
			'label'		=> __( 'Featured Header Image Alt/Title Tag ', 'clean-journal' ),
			'section'   => 'header_image',
	...
	$wp_customize->add_control( 'clean_journal_theme_options[featured_header_image_url]', array(
			'label'		=> __( 'Featured Header Image Link URL', 'clean-journal' ),
			'section'   => 'header_image',
