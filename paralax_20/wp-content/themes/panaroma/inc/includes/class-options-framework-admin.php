...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Theme Options', 'panaroma' ),
			'menu_title' => __( 'Theme Options', 'panaroma' ),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'panaroma-options',
     ...
     */
	 function options_page() { ?>
	    ...
	    <h2 class="nav-tab-wrapper">
          ...
          <div style="padding-top:10px;font-size:15px;"><a href="<?php echo esc_url(SKT_THEME_URL_DIRECT); ?>" target="_blank"><?php _e('Buy PRO version for only $39 with more features.','panaroma'); ?></a></div>
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox"  style="width:72%; float:left;">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'panaroma' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'panaroma' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'panaroma' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
            ...
            <div class="meta-box-sortables ui-sortable">
                ...
                <div class="postbox">
                    <h3 class="hndle"><span><?php _e('Documentation','panaroma'); ?></span></h3>
                    <div class="inside">
                        <p><em><?php _e('For documentation and support check this link','panaroma'); ?> : <strong><a href="<?php echo esc_url(SKT_THEME_DOC); ?>" target="_blank">Panaroma Theme Documentation</a></strong></em></p>
                    </div>
                </div>
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'panaroma' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'panaroma' ), 'updated fade' );
	}
