        ...
        <div class="container">
            ...
            <?php if (isset($hasError) || isset($captchaError)) { ?>
                   ...
                   ?>" class="text required requiredField email">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                           <textarea class="form-control" name="comments" id="commentsText" placeholder="<?php echo CONTACT_MESSAGE; ?>"  class="required requiredField message" required value="<?php
