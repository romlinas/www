...
class Matrix_Welcome {
	...
	public function Matrix_lite_welcome_screen() {
		...
		<ul class="matrix-lite-nav-tabs" role="tablist">
			...
			<li role="presentation"><a href="#child_themes" aria-controls="child_themes" role="tab" data-toggle="tab"><?php esc_html_e( 'Premium Products','matrix'); ?></a></li>
		...
		<div class="matrix-lite-tab-content">
			 ...
			 * @hooked Matrix_lite_welcome_github - 40
