...
if (($matrix_theme_options['home_slider_enabled'] == 1) && isset($matrix_theme_options['home_slider_posts']) && ($matrix_theme_options['home_slider_posts']!="" ) && !empty($matrix_theme_options['home_slider_posts'])) { 
?>
...
<?php } elseif($matrix_theme_options['home_slider_enabled'] == 1) { ?>
<!-- Start Home Page Slider -->
    <section id="home">
      <!-- Carousel -->
      <div id="main-slide" class="carousel slide" data-ride="carousel">
