    ...
    <div class="page-banner">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2><?php if (is_day()):
                            printf(__('Daily Archives: %s', 'matrix'), '<span>' . get_the_date() . '</span>');
                        elseif (is_month()) :
                            printf(__('Monthly Archives: %s', 'matrix'), '<span>' . get_the_date(_x('F Y', 'monthly archives date format', 'matrix')) . '</span>');
                        elseif (is_year()) :
                            printf(__('Yearly Archives: %s', 'matrix'), '<span>' . get_the_date(_x('Y', 'yearly archives date format', 'matrix')) . '</span>');
                        else :
                            _e('Archives', 'matrix');
                        endif; ?></h2>
                </div>
