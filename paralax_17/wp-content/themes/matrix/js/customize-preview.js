(function ($) {
    wp.customize('matrix_theme_options[logo_height]', function (value) {
        value.bind(function (to) {
            $('img#logoimg').attr('height', to + 'px');
        });
    });
    wp.customize('matrix_theme_options[logo_width]', function (value) {
        value.bind(function (to) {
            $('img#logo').css('width', to + 'px');
        });
    });
    ...
    wp.customize('matrix_theme_options[logo_top_spacing]', function (value) {
        value.bind(function (to) {
            $('a#alogo,img#logo').each(function () {
