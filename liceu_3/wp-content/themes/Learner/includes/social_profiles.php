<?php
    ...
    class Themater_Social_Profiles
    {
        ...
        function themater_options()
        {
            ...
            $this->theme->admin_option(array('Соц. профили', 16), 
                'Соц. профили' , 'social_profiles', 
                'content', 'Добавить кнопки-ссылки на профили в соц. сетях.'
            );
            
            $this->theme->admin_option('Соц. профили', 
