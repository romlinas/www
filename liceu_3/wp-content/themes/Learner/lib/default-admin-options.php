...
*/
    ...
    $this->admin_option(array('Поддержка', 9999), 
    ...
    */
        ...
        // General Settings
        $this->admin_option('Главное',
            'Логотип', 'themater_logo_source', 
            'callback', 'image', 
            array('callback' =>'themater_logo_source')
        );
        
        $this->admin_option('Главное', 
            'Разделитель картинки-логотипа', 'themater_logo_image_wrap', 
        ...
        $this->admin_option('Главное', 
            ...
            array('display' => 'minimal', 'help' => "Укажите полный путь до картинки-логотипа и загрузите его прямо сейчас.")
        );
        
        $this->admin_option('Главное', 
            'Конец разделителя картинки-логотипа', 'themater_logo_image_wrap_end', 
            'raw', '</div>', 
            array('display'=>'clean')
        );
        
        $this->admin_option('Главное', 
            'Разделитель текста-логотипа', 'themater_logo_text_wrap', 
        ...
        $this->admin_option('Главное', 
            'Конец разделителя текста-логотипа', 'themater_logo_text_wrap_end', 
            'raw', '</div>', 
            array('display'=>'clean')
        );
        ...
        $this->admin_option('Главное', 
            ...
            array('help' => "Укажите полный путь до картинки-значка сайта и загрузите его. Оставьте поле пустым, если не нуждаетесь в favicon.")
        );
        
        $this->admin_option('Главное',
            'Эл. почта контактной формы', 'contact_form_email', 
            'text', get_option('admin_email'),
            array('display' => 'extended', 'help' => 'Сообщения, принимаемые с контактной формой будут отправлены на этот адрес электронной почты.')
        );
    ...
    */
        ...
        $this->admin_option('Слой',
            'Текст "Read More"', 'read_more', 
            'text', 'Читать далее'
        );
        
        
        $this->admin_option('Слой', 
            'Настройки прикрепленных изображений', 'featured_image_settings', 
            'content', ''
        );
        
        $this->admin_option('Слой', 
            'Прикрепленные картинки на главной странице', 'featured_image_settings_homepage', 
            'raw', '<b>&raquo;</b> Настройки прикрепленных картинок на страницах результатов поиска, архивов, главной, архивов меток и т.п.<br /><br />'
        );
        
        $this->admin_option('Слой',
            'Ширина картинки', 'featured_image_width', 
            'text', '200', 
            array('display'=>'inline', 'style'=>'width: 100px;', 'suffix'=>' px.')
        );
        
        $this->admin_option('Слой',
            'Высота картинки', 'featured_image_height', 
            'text', '160', 
            array('display'=>'inline', 'style'=>'width: 100px;', 'suffix'=>' px.')
        );
        
        $this->admin_option('Слой',
            'Выраванивание', 'featured_image_position', 
            'radio', 'alignleft', 
            array('options'=>array('alignleft' => 'Left', 'alignright'=> 'Right', 'aligncenter'=>'Center') , 'display'=>'inline')
        );
        
        $this->admin_option('Слой', 
            'Настройки прикрепленных картинок на одиночных страницах', 'featured_image_settings_single', 
            'raw', '<b>&raquo;</b> Настройки прикрепленных картинок на одиночных страницах, на страницах записей.<br /><br />'
        );
        
        $this->admin_option('Слой',
            'Ширина картинки', 'featured_image_width_single', 
            'text', '300', 
            array('display'=>'inline', 'style'=>'width: 100px;', 'suffix'=>' px.')
        );
        
        $this->admin_option('Слой',
            'Высота картинки', 'featured_image_height_single', 
            'text', '225', 
            array('display'=>'inline', 'style'=>'width: 100px;', 'suffix'=>' px.')
        );
        
        $this->admin_option('Слой',
            'Положение картинки', 'featured_image_position_single', 
            'radio', 'alignleft', 
            array('options'=>array('alignleft' => 'Left', 'alignright'=> 'Right', 'aligncenter'=>'Center') , 'display'=>'inline')
        );
        
        $this->admin_option('Слой', 
            'Произвольный текст в подвале', 'footer_custom_text', 
            'textarea', '', 
            array('help' => 'Добавьте пользовательский текст подвала. Перекроет значение по умолчанию, сгенерированный темой текст.', 'display'=>'extended-top', 'style'=>'height: 140px;')
        );
     ...
     *********************************************
    */
        $this->admin_option('Интеграция',
            'Ссылка на RSS Feed', 'rss_url', 
            'text', '', 
            array('help' => 'Введите ссылку на ваш канал RSS, Feedburner или другие.', 'display'=>'extended-top')
        );
        
        $this->admin_option('Интеграция',
            'Произвольный CSS', 'custom_css', 
            'textarea', '', 
            array('help' => 'Добавьте любой CSS код без блоков &lt;style&gt;&lt;/style&gt; на все страницы вашего сайта, последние вставляются автоматически.', 'display'=>'extended-top', 'style'=>'height: 180px;')
        );
        
        $this->admin_option('Интеграция',
            'Head-код', 'head_code', 
            'textarea', '', 
            array('help' => 'Произвольный код, который располагается перед тегом &lt;/head&gt; каждой страницы вашего сайта.', 'display'=>'extended-top', 'style'=>'height: 180px;')
        );
        
        $this->admin_option('Интеграция',
            'Код в подвале', 'footer_code', 
            'textarea', '', 
            array('help' => 'Произвольный код, который располагается перед тегом &lt;/body&gt; каждой страницы вашего сайта.', 'display'=>'extended-top', 'style'=>'height: 180px;')
        );
    ...
    */
    ...
    $this->admin_option('Сброс настроек',
        'Сбросить настройки темы', 'reset_options', 
        'content', '
        <div id="fp_reset_options" style="margin-bottom:40px; display:none;"></div>
        <div style="margin-bottom:40px;"><a class="button-primary tt-button-red" onclick="if (confirm(\'Все предыдущие сохраненные настройки будут утеряны! Вы действительно хотите продолжить?\')) { themater_form(\'admin_options&do=reset\', \'fpForm\',\'fp_reset_options\',\'true\'); } return false;">Сбросить настройки сейчас</a></div>', 
        array('help' => 'Сброс настроек темы на значения по умолчанию. <span style="color:red;"><strong>Внимание:</strong> Все предыдущие сохраненные настройки будут утеряны!</span>', 'display'=>'extended-top')
    );
    ...
    */
    ...
    function themater_logo_source()
    {
        ...
        $logo_sources = array('image'=> 'Картинка логотип', 'text'=> 'Произвольный текст');
