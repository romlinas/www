        ...
        ?>
            ...
            <div class="tt-widget">
                <table width="100%">
                    ...
                    <tr>
                        <td class="tt-widget-label"><label for="<?php echo $this->get_field_id('url'); ?>">URL страницы на Facebook:</label></td>
                    ...
                    <tr>
                        ...
                        <td class="tt-widget-content">
                            <select name="<?php echo $this->get_field_name('colorscheme'); ?>">
                                <option value="light" <?php selected('alignleft', $instance['colorscheme']); ?> >Светлая</option>
                                <option value="dark"  <?php selected('alignright', $instance['colorscheme']); ?>>Темная</option>
                             </select>      
                             &nbsp; &nbsp; Цвет обводки: <input type="text" style="width: 50px;" name="<?php echo $this->get_field_name('border'); ?>" value="<?php echo esc_attr($instance['border']); ?>" /> <em>Например: #ffffff</em>                      
                        </td>
                    </tr>

                    <tr>
                        <td class="tt-widget-label">Иные настройки:</td>
                        <td class="tt-widget-content">
