...
class ThematerSocialProfiles extends WP_Widget 
{
    function __construct() 
    {
        ...
        $widget_options = array('description' => 'Кнопки на ваши профили в социальных сетях.' );
        $control_options = array( 'width' => 480);
        parent::__construct('themater_social_profiles', '&raquo; Социальные профили', $widget_options, $control_options);
    }
    ...
    <div class="themater_social_profiles_widget">
        ...
        <div style="margin-bottom: 20px;">
            <a class="button" onclick="themater_sp_new('<?php echo $this_id; ?>');" >Добавить новый профиль</a> &nbsp; &nbsp; 
        </div>
        <?php
                ...
                foreach($get_profiles as $sp_id=>$sp) {
                    ...
                    <div id="sp_container_<?php echo $this_id . $sp_id; ?>" style="padding: 0 0 10px 0; border-bottom: 1px solid #ddd; margin-bottom: 10px;" >
                        <div class="tt-clearfix" style="background: #eee; border: 1px solid #ddd; border-left: 4px solid #ddd; padding: 4px 8px;">
                            ...
                            <div style="float: right;"><a class="tt-link" onclick="themater_togle('sp_edit_<?php echo $this_id . $sp_id; ?>');">Правка</a> | <a class="tt-link" onclick="themater_sp_delete('<?php echo $this_id . $sp_id; ?>');">Удалить</a></div>
                        </div>
                        ...
                        <div class="tt-hidden" id="sp_edit_<?php echo $this_id . $sp_id; ?>" style="background: #fff; padding: 10px; border: 1px solid #ddd; border-top: 0;">
                            ...
                            <div class="tt-widget">
                                <table width="100%">
                                    <tr>
                                        <td class="tt-widget-label" width="25%">Заголовок:</td>
                                    ...
                                    <tr>
                                        <td class="tt-widget-label" width="25%">Кнопка:</td>
                                        <td class="tt-widget-content" width="75%">
                                            <?php
                                                if($sp['button']) {
                                                    ?>
        ...
        ?>
            ...
            <div id="themater_sp_new_<?php echo $this_id; ?>" style="display: none;">
                ...
                <div id="sp_container_the__id__" style="padding: 0 0 10px 0; border-bottom: 1px solid #ddd; margin-bottom: 10px;" >
                    <div class="tt-clearfix" style="background: #eee; border: 1px solid #ddd; border-left: 4px solid #ddd; padding: 4px 8px;">
                        <div style="float: left;"><span style="font-weight: bold;" id="sp_title_the__id__">Новый профиль</span></div>
                        <div style="float: right;"><a class="tt-link" onclick="themater_togle('sp_edit_the__id__');">Правка</a> | <a class="tt-link" onclick="themater_sp_delete('the__id__');">Удалить</a></div>
                    </div>
