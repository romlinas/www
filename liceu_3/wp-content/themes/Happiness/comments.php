...
<div id="respond">
<br />
<h3><?php comment_form_title( 'Оставить отзыв', 'Оставить отзыв к %s' ); ?></h3>
...
<!--<p><small><strong>XHTML:</strong> You can use these Метки: <code><?php echo allowed_tags(); ?></code></small></p>-->
