		...
		<div id="outer-wrapper" class="outer-wrapper">  
			<div class="outer">
				...
				<div id="header" class="outer">
					...
					<div class="header-part rightsector">
                        <div style="padding: 0 0 0 0; text-align:right;"><?php echo get_theme_option('ad_header'); ?>
                        </div>
					</div>
				</div>
			...
			<div class="outer">
				<div class="navi-secondary-container">
					<?php
                    if(function_exists('wp_nav_menu')) {
                            wp_nav_menu( 'theme_location=menu_2&menu_class=navi-secondary navis&container=&fallback_cb=menu_2_default');
                        } else {
                            menu_2_default();
                        }
