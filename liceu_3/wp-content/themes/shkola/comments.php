...
if (function_exists('comment_form')){
	...
	comment_form();
	theme_post_wrapper(array('content' => str_replace(array(' id="respond"', 'type="submit"'), array('', 'class="button" type="submit"'), ob_get_clean()), 'id' => 'respond'));
	return;
}
...
<p>
	<span class="button-wrapper"><span class="button-l"> </span><span class="button-r"> </span>
		<input class="button" type="submit" name="submit" tabindex="5" value="<?php _e('Submit Comment', THEME_NS); ?>" />
	</span>
