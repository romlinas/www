    ...
    <div class="header">
        <div class="header-position">
            <div class="header-wrapper">
                ...
                <<?php echo $headline; ?> class="logo-name"><a href="<?php echo get_option('home'); ?>/"><?php bloginfo('name'); ?></a></<?php echo $headline; ?>>
                <?php endif; ?>
                <?php if(theme_get_option('theme_header_show_slogan')): ?>
                <?php $slogan = theme_get_option('theme_'.(is_single()?'single':'posts').'_slogan_tag'); ?>
                    <<?php echo $slogan; ?> class="logo-text"><?php bloginfo('description'); ?></<?php echo $slogan; ?>>
                <?php endif; ?>
                </div>
                </div>
            </div>
