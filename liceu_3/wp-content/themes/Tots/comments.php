...
<p>Вы должны <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>">авторизироваться</a> чтоб оставить ответ.</p>
<?php else : ?>
...
<label for="email"><small>Mail (не будет публиковаться) <?php if ($req) echo "(обязательно)"; ?></small></label></p>
...
<p><input name="submit" type="submit" id="submit" tabindex="5" value="Послать" />
