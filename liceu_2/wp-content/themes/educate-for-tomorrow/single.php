...
<!-- content start -->
		...
		<?php if(have_posts()) : ?>
			<div class="post_path">Вы здесь: <a href="<?php bloginfo('url'); ?>">Главная</a> &gt; <?php the_category(', '); ?> &gt; <?php the_title(); ?></div>
...
<div class="post_bottom">
                ...
                <div class="postmetadata">Опубликовано в <?php the_category(', ') ?></div>
			...
			<?php if(function_exists('wp_pagenavi')) { wp_pagenavi(); } else { ?>
					...
					<div class="alignright"><?php previous_posts_link('NНовые записи;') ?></div>
					</div>
					<?php } ?>
		<?php else : ?>
		<div class="notfound"><p>Соединение отсутствует!</p><p>Попробуйте позднее.</p></div>
		<?php endif; ?>
		</div>
<!-- content end -->
	</div>
