...
*** Customizing this Theme
---------------------------
1. Go to WP Dashboard and look for the "Theme Options" section.

2. Follow the step by step instruction supplied on the Theme Options page to customize the theme to suit your needs.

3. If you would like to have sliding gallery as well, upload the vslider folder you'll find in this theme's folder into the plugins folder on your server. Then go to WP Dashboard and look for the "vSlider" section where you can customize your gallery.
