    ...
    <?php 
        ...
        <div class="bx-slider">
			<div class="slides">
				...
				<div class="slider-caption">
					<div class="ak-container">
						<h1 class="caption-title">Programming Software</h1>
						<h2 class="caption-description">Cutting edge solutions for web application development.</h2>
					</div>
				</div>
                <?php  endif; ?>
			</div>
			...
			<div class="slides">
				...
				<div class="slider-caption">
					<div class="ak-container">
						<h1 class="caption-title">Creating the future</h1>
						<h2 class="caption-description">We contribute to the realization of your potential and ambitions. One innovation at a time.</h2>
					</div>
				</div>
                <?php  endif; ?>
			</div>
			...
			<div class="slides">
				...
				<div class="slider-caption">
					<div class="ak-container">
						<h1 class="caption-title">Innovations & Progress</h1>
						<h2 class="caption-description">In a World of Technology, People Make the Difference.</h2>
					</div>
				</div>
                <?php  endif; ?>
			</div>
