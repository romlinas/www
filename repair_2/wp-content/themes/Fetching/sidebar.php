	...
	<div class="span-7">
        ...
        <?php if(get_theme_option('video') != '') {
			...
			<div class="sidebarvideo">
				<ul> <li><h2 style="margin-bottom: 10px;"><?php _e('Featured Video', 'dtheme'); ?></h2>
		...
		?>
			...
			<ul>
				<?php 
					...
					<li id="tag_cloud"><h2><?php _e('Tags', 'dtheme'); ?></h2>
						<?php wp_tag_cloud('largest=16&format=flat&number=20'); ?>
					</li>
				
					<li> 
						<h2><?php _e('Calendar', 'dtheme'); ?></h2>
						<?php get_calendar(); ?> 
					</li>
	...
	<div class="span-4 last">
		...
		<div class="sidebar right-sidebar">
			...
			<ul>
                ...
                <li><h2><?php _e('Archive', 'dtheme'); ?></h2>
					<ul>
