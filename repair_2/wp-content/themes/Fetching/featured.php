			...
			<div id="myGallery">
				...
				if($featured_posts_category != '' && $featured_posts_category != '0') {
					...
					for($i = 1; $i <=5; $i++) {
						?>
							<div class="imageElement">
								<h3><?php printf(__('This is featured post %s title', 'dtheme'), $i); ?> </h3>
								<p><?php _e('To set your featured posts, please go to your theme options page in wp-admin. You can also disable featured posts slideshow if you don\'t wish to display them.', 'dtheme'); ?></p>
								<a href="#" title="<?php _e('This is featured post', 'dtheme'); ?> <?php echo $i; ?>" class="open"></a> 
