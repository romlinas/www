		...
		<div id="container" class="container">  
			<div class="span-18">
    			<div id="pagemenucontainer">
                    ...
                    function menu_1_default()
                    {
                        ?>
                        <ul id="pagemenu">
    						<li <?php if(is_home()) { ?> class="current_page_item" <?php } ?>><a href="<?php echo get_option('home'); ?>/"><?php _e('Home', 'dtheme'); ?></a></li>
            ...
            <div class="span-6 last" id="topsearch">
				...
				<div id="header" class="span-24">
					...
					<div class="span-13 last" style="padding-top: 44px; text-align:center;">
				...
				<div id="navcontainer">
                    ...
                    if(function_exists('wp_nav_menu')) {
                        ...
                        function menu_2_default()
                        {
                            ?>
                            <ul id="nav">
                                <li <?php if(is_home()) { echo ' class="current-cat" '; } ?>><a href="<?php bloginfo('url'); ?>"><?php _e('Home', 'dtheme'); ?></a></li>
