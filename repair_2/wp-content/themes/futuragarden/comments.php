...
<?php if ($comments) : ?>
	<h3 id="comments"><?php comments_number('Отзывов нет', 'Один отзыв', 'Отзывов: % Responses' );?> на &laquo;<?php the_title(); ?>&raquo;</h3> 
 ...
 <?php else : // this is displayed if there are no comments so far ?>
  ...
  <?php if ('open' == $post-> comment_status) : ?> 
	 ...
	 <?php else : // comments are closed ?>
		...
		<p class="nocomments">К сожалению, комментарии закрыты.</p>
