...
function art_add_admin() {
    ...
    add_theme_page("Kitchen WP Theme Options", "Kitchen WP Theme Options", 'edit_themes', basename(__FILE__), 'art_admin');
...
?>
<div class="wrap">
	<h2>Kitchen WP Theme Options</h2>
