...
$themename = "interior_design_album";
$shortname = "artisteer";
...
function art_add_admin() {
    ...
    add_theme_page("Interior Design Album Options", "Interior Design Album Options", 'edit_themes', basename(__FILE__), 'art_admin');
...
?>
<div class="wrap">
	<h2>Interior Design Album Options</h2>
